...
namespace BookInventoryAdminProgram.ViewModel
{
    public class LoginWindowViewModel : ViewModelBase, INotifyDataErrorInfo
    {
        ...
        public LoginWindowViewModel(NavigationStore navigationStore, Func<HomeViewModel> createHomeViewModel, Action openMainWindow, UserInfoStore userInfoStore, DatabaseHashStore _databaseHashStore)
        {
            LoginCommand = new LoginCommand(this, navigationStore, createHomeViewModel, openMainWindow, userInfoStore, _databaseHashStore);
